...
//Solution 2
let sliced = inventory.slice(-1);
let lastCar = sliced[0];
console.log("lastCar", lastCar);
console.log("lastCar sentence", `The last car is a ${lastCar.car_year} ${lastCar.car_make} ${lastCar.car_model}` );
...
let arrayToAString = JSON.stringify(BMWAndAudi);


console.log(arrayToAString);
